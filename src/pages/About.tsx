      ...
      <section className="py-16">
        <div className="max-w-[1200px] mx-auto px-5">
          <div className="grid md:grid-cols-[1.5fr_1fr] gap-16 items-center">
            <div>
              <h2 className="text-primary font-bold text-2xl md:text-3xl mb-6">
              ...
              <div className="flex flex-col-reverse md:flex-row justify-between items-center md:items-start gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-accent font-semibold">
                    CGPA: 3.10 out of 4.0
                  </p>
                </div>
                <img
                  src="/ju.png"
                  alt="Jahangirnagar University"
                  className="w-full max-w-[200px] md:max-w-[150px] lg:max-w-[200px] h-auto object-contain mx-auto md:ml-3 md:mr-0"
                />
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              <div className="text-5xl mb-4">
                <img
                  src="/bmp.png"
                  alt="BMP"
                  className="inline-block max-w-[200px] md:max-w-[200px] lg:max-w-[250px]"
                />
              </div>
              <h3 className="text-primary font-bold mb-4">
                Gender, Empowerment of Women and Development
              </h3>
              <p className="text-text-dark font-semibold mb-2">
                Bangladesh Mahila Parishad
              </p>
              <p className="text-text-light text-sm">
                Duration: 3 months | Year: 2022
              </p>
            </div>
